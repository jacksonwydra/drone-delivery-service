...
def make_pilot_nav(parent, controller):
    ...
    remove_pilot_button = make_nav_button(nav, controller, RemovePilotFrame, 'Remove', parent)
    remove_pilot_button.grid(row=0, column=2, sticky='w')
...
class RemovePilotFrame(tk.Frame):
    def __init__(self, parent, controller, **kwargs):
        tk.Frame.__init__(self, parent)
