...
def make_employee_nav(parent, controller):
    ...
    fire_employee_button = make_nav_button(nav, controller, FireEmployeeFrame, 'Fire', parent)
    fire_employee_button.grid(row=0, column=3, sticky='w')
...
class FireEmployeeFrame(tk.Frame):
    def __init__(self, parent, controller, **kwargs):
        tk.Frame.__init__(self, parent)
